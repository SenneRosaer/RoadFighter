...
int roadfighter::MovingCar::getSpeed() { return speed; }

int roadfighter::MovingCar::Delete() { return toDel; }
...
void roadfighter::MovingCar::setDelete(int del) { toDel = del; }

bool roadfighter::MovingCar::Shoot() { return false; }
