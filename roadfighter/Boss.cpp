...
const std::vector<double>& roadfighter::Boss::getRockPos() const { return rockPos; }

int roadfighter::Boss::getSpeed() { return currentspeed; }

int roadfighter::Boss::Delete() { return toDel; }

void roadfighter::Boss::setDelete(int del) { toDel = del; }

bool roadfighter::Boss::Shoot() { return false; }

std::shared_ptr<ObjBox> roadfighter::Boss::getObjbox() { return std::make_shared<ObjBox>(centralpos, height, width); }

bool roadfighter::Boss::isGetRocks() const { return getRocks; }

void roadfighter::Boss::setGetRocks(bool getRocks) { Boss::getRocks = getRocks; }

int roadfighter::Boss::getLife() const { return life; }

void roadfighter::Boss::setLife(int life) { Boss::life = life; }
