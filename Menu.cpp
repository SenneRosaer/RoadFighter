...
Menu::Menu(std::shared_ptr<sf::RenderWindow> windowGiven, std::shared_ptr<ConfigData> config)
{
        ...
        text[1].setOrigin(rect2.left + rect2.width / 2.0f, rect2.top + rect2.height / 2.0f);
        ...
        text[2].setOrigin(rect3.left + rect3.width / 2.0f, rect3.top + rect3.height / 2.0f);
...
int Menu::GetSelected() { return selected + 1; }
